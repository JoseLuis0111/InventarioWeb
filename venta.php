                      ...
                      <div class="venta-opts">
                        ...
                        <script>
                          ...
                          function addProductToList(id,nombre,precio){
                             ...
                             totalProd = precio*unitsToAdd;

                             totalVenta += totalProd

                             //alert("ID: "+ id + "\nNombre: " + nombre + "\nUnidades: " + unitsToAdd + "\nTotal: " + total);

                             listObjts.push( new Product(id, nombre, unitsToAdd, totalProd) );

                             console.log(listObjts);

                             //var venta = nombre +" "+ unitsToAdd +" $"+ totalProd;
                             ...
                             document.getElementById("total-venta").innerHTML = '$' + totalVenta;

                             var parameters = "idProd="+id+"&name="+nombre+"&units="+unitsToAdd+"&TotalProd="+totalProd;
                             ...
                             const xhttp3 = new XMLHttpRequest();
                                     ...
                                     xhttp3.onload = function() {
                                       ...
                                       var divResultado = document.getElementById("divProductsList");
                                       divResultado.innerHTML += this.responseText;

                                     }

                                     xhttp3.open("GET", "addProductToList.php?"+parameters, true);
                                     xhttp3.send();
                            }

                            function confirm(){
                              var lst = JSON.stringify(listObjts);
