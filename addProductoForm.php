            ...
            <div id="contenido" class="contenido">
                ...
                <div class="div-addProducto">
                  ...
                  <div class="div-addProd-Form">
                    ...
                    <form class="addProd-form" action="addProducto.php" method="post" enctype="multipart/form-data">

                        <label for="Name" class="label-text" >Nombre:</label><br>
                        <input class="add-form-objts" type="text" name="name" placeholder="Ingrese el nombre del producto" autofocus required>
                        
                        <div class="precio-unidades">

                          <div>
                            <label for="price" class="label-text">Precio:</label><br>
                            <input type="number" name="price" min="0" step="0.01" placeholder="$..." class="add-form-objts" required>
                          </div>
                          
                          <div>
                            <label for="units" class="label-text">Unidades:</label><br>
                            <input type="number" name="units" min="1" placeholder="0" class="add-form-objts" required>
                          </div>
                        ...
                        <input class="addProdBtn" type="submit" name="submit" value="Agregar producto">
